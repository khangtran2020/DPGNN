...
duchi_save_path = '../Datasets/NUS_FLICK/duchi_eps_{}'.format(epsilon)
hybrid_save_path = '../Datasets/NUS_FLICK/hybrid_eps_{}'.format(epsilon)
piecewise_save_path = '../Datasets/NUS_FLICK/piecewise_eps_{}'.format(epsilon)
threeoutput_save_path = '../Datasets/NUS_FLICK/threeoutput_eps_{}'.format(epsilon)
PM_save_path = '../Datasets/NUS_FLICK/PM_eps_{}'.format(epsilon)
