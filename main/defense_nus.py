...
feat_file = 'Data/NUS/feats/nus_resnet50_plain_feat.npy'
edge_file = 'Data/NUS/pairs/flickr_nus.pairs'
dataset = FlickrNUSDataset(feat_file=feat_file, feat_folder=None, num_batch=None, edge_org = edge_file, edge_generated = None, type_test = 'clean')
...
trainer = TrainerDefense(num_epoch=epochs, learning_rate=learning_rate, patience=patience, model=model, graph=graph,
                         name_model='22JAN2022/nus_defense_model_lapedge_eps_{}.pt'.format(epsilon), device=device)
