...
from Trainer.Trainer import Trainer, TrainerDefense, TrainerPPI
import torch
import sys
...
trainer = TrainerPPI(num_epoch=epochs, learning_rate=learning_rate, patience=patience, model=model, dataset_train=dataset_train_perturb,
                dataset_val=dataset_val_perturb, dataset_test=dataset_test_perturb, name_model='22JAN2022/ppi_defense_model_lapedge_eps_{}.pt', device=device, train_mode='clean')
